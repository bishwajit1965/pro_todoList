        ...
        <div class="row">
            <div class="col-sm">
                ...
                <form action="ProcessData.php" method="post" class="mb-4">
                    ...
                    <button type="submit" onclick="return confirm('Are you sure that you want to delete this data ?')" value="delete-todo" name="submit" class="btn btn-sm btn-danger"><i class="bi bi-trash"></i> Delete</button>
